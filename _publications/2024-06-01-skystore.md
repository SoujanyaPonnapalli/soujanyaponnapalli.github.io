...
authors: 'Shu Liu, Xiangxi Mo, Moshik Hershcovitch, Henric Zhang, Audrey Cheng, Guy Girmonsky, Gil Vernik, Michael Factor, Tiemo Bang, Soujanya Ponnapalli, Natacha Crooks, Joseph E. Gonzalez, Danny Harnik, and Ion Stoica'
...
conf: 'VLDB'
confyear: 2025
award: 'Best of VLDB’25 nomination'
# Key insight: 2-3 lines, shown under the venue on the publications page.
keyinsight: 'Object stores that are designed for a single cloud leave managing data transfers across clouds and regions, guided by their applications'' access patterns, to users themselves. We redefine this as a caching problem, though an unusual one: capacity is effectively unlimited, and the cost budget must account for moving data across regions and clouds. With SkyStore, we show that a TTL-based policy can replicate and evict data while minimizing cost and latency.'
paperurl: 'https://doi.org/10.14778/3734839.3734846'
slidesurl: ''
talkurl: ''
citationurl: '/files/bib/skystore-vldb25.bib'
